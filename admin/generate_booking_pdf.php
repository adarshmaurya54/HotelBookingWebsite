...
if (!(isset($_GET['gen_pdf']) && $_GET['id'] != '') || !(is_numeric($_GET['id']) && intval($_GET['id']) == $_GET['id'])) { #checking if id index is present in $_get variable and value is an integer value...
    redirect("./index.php");
} else {
